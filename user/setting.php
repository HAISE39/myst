                    ...
                    <div class="row">
                        <div class="col-9">
                            <div class="d-flex align-items-center align-self-start">
                                <h3 class="mb-0">Rp <?php echo number_format($data_user['saldo'], 0, ',', '.'); ?></h3>
                            </div>
                        </div>
                        <div class="col-3">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-9">
                            <div class="d-flex align-items-center align-self-start">
                                <h3 class="mb-0">Rp <?php echo number_format($data_order_sosmed['total'], 0, ',', '.'); ?></h3>
                    ...
                    <h6 class="text-muted font-weight-normal">Total Pemesanan Sosmed</h6>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-9">
                            <div class="d-flex align-items-center align-self-start">
                                <h3 class="mb-0">Rp <?php echo number_format($data_order_ppob['total'], 0, ',', '.'); ?></h3>
                                <p class="text-success ml-2 mb-0 font-weight-medium">(<?php echo $jumlah_order_ppob; ?>)</p>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="icon icon-box-success">
                    ...
                    <h6 class="text-muted font-weight-normal">Total Pemesanan PPOB</h6>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-9">
                            <div class="d-flex align-items-center align-self-start">
                                <h3 class="mb-0">Rp <?php echo number_format($data_deposit_user['total'], 0, ',', '.'); ?></h3>
                                <p class="text-primary ml-2 mb-0 font-weight-medium">(<?php echo $jumlah_deposit_user; ?>)</p>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="icon icon-box-primary">
                                <span class="mdi mdi mdi-briefcase-download icon-item"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td style="min-width: 80px;">
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm bg-dark" value="<?php echo $data_user['api_key']; ?>" id="apikey-<?php echo $data_user['id']; ?>" readonly="">
                            ...
                            <tr>
                                <th width="45%">Referral Kode</th>

                                <td style="min-width: 80px;">
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm bg-dark" value="<?php echo $data_kodeReferral['kode']; ?>" id="apikey-<?php echo $data_kodeReferral['id']; ?>" readonly="">
                                        <button data-toggle="tooltip" title="Copy Apikey" class="btn btn-xs btn-primary" type="button" onclick="copy_to_clipboard('apikey-<?php echo $data_kodeReferral['id']; ?>')"><i class="mdi mdi-content-copy"></i></button>
                                    </div>
                        ...
                        <div class="tab-pane" id="api" role="api" aria-labelledby="api-tab">
                            <form class="form-horizontal" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control form-control-sm bg-dark" name="api" value="<?php echo $data_user['api_key']; ?>" id="apikey-<?php echo $data_user['id']; ?>" readonly="">
                                    </div>
                                </div>
                                <br />
                                <br />
