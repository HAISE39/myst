...
if (isset($_POST['id'])) {
    ...
    $cek_pesanan = $conn->query("SELECT * FROM pembelian_ppob WHERE id = '$post_id' AND user ='$sess_username'");
...
?>
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-box">
                ...
                <tr>
                    <th class="table-detail">No Meter</th>
                    <td class="table-detail"><?php echo $data_pesanan['no_meter']; ?></td>
                </tr>
                <tr>
