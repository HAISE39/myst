...
$username = $data_depo['username'];
    ...
    if ($depo == 0) {
        $_SESSION['hasil'] = array('alert' => 'danger', 'judul' => 'Data Invoice Tidak Ditemukan', 'pesan' => 'Tidak Menemukan Data Tagihan Deposit.');
        ...
        if ($data_depo['tipe'] == "QRIS") {
            ...
            $TJ = "";
            $info_tujuan = "QRIS";
        } else if ($data_depo['tipe'] == "QRIS2" or $data_depo['tipe'] == "QRISMU") {
            $image = "";
            $T_QR = "hidden";
            $TJ = "";
